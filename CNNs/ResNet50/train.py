...
if __name__ == '__main__':
    ...
    train_batch_len = 64
    valid_batch_len = 32
    Train_Images_Set = "ResNet50/TrainImageNameList.csv"
    Valid_Images_Set = "ResNet50/ValImageNameList.csv"
    ...
    for epoch in range(epochs):
        ...
        for x_val_a, y_val_a in minibatches(X_val, y_val, batch_size=valid_batch_len, shuffle=True, ratio=4):
